  ...
  return (
    <div className="termsTextSet">
      <div className="info">
        ...
        is a legally binding agreement that contains important information about
        our Website and your permitted use of it. From time to time we may
        unilaterally modify this User Agreement, so it is important that you
        review this User Agreement every time you use this Website
      </div>
      ...
      <div className="info">
        ...
        to Plundur and its products and services, and similar items from our
        business partners, licensors, and licensees, and other third parties The
        Content may be in the form of information, text, data, images, graphics,
        button icons, registered and unregistered trademarks, illustrations,
        photographs, audio clips, music, sounds, pictures, videos, software, or
        other forms and formats now known or later invented. In using this
        Website, you must respect the intellectual property rights of Plundur.io
        and others, all as outlined below. Your unauthorized use of Content may
      ...
      <div className="info">
        ...
        be used to create or promote products, software or services other than
        related to Plundur.io. The use or amendment of code and scripts outside
        of the Plundur.io environment is prohibited in any circumstance.
      </div>
      ...
      <div className="info">
        ...
        and except for products purchased via this Service. You may at any time
        terminate any Account created by following the instructions set out on
        the Website.
      </div>
    </div>
  );
